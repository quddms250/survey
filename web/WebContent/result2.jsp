...
<body class="result">
    ...
    <section id="result">
        <div class="wrap">
            ...
            <div class="r_wrap">
                <img src="http://www.sanaesai.com/img/str/str2.gif" alt="">
                <a href="http://www.sanaesai.com/img/str/str2.gif" download>저장하기</a>
            </div>
        </div>
    </section>
    <section id="strc">
        <div class="wrap">
            <div class="top_wrap">
                ...
                <h2>땅에 있는 당근 뽑기</h2>
                <span>척추,허벅지,종아리</span>
            </div>
            <div class="img_wrap">
                <img src="http://www.sanaesai.com/img/str/St_02.gif" alt="">
                <img src="http://www.sanaesai.com/img/res/Ellipse.png" alt="">
            </div>
            <div class="txt_wrap r1">
                <div>허리에 무리가 가지 않도록!</div>
                <div>무릎이 약간 접혀도 됩니다!</div>
                <div>시원하게 허리를 늘려보아요!</div>
            </div>
        </div>
    </section>
    <script>
