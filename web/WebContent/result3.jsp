...
<body class="result">
    ...
    <section id="result">
        <div class="wrap">
            ...
            <div class="r_wrap">
                <img src="http://www.sanaesai.com/img/str/str3.gif" alt="">
                <a href="http://www.sanaesai.com/img/str/str3.gif" download>저장하기</a>
            </div>
        </div>
    </section>
    <section id="strc">
        <div class="wrap">
            <div class="top_wrap">
                ...
                <h2>땅 속 두더지 잡기</h2>
                <span>골반, 허벅지, 엉덩이</span>
            </div>
            <div class="img_wrap">
                <img src="http://www.sanaesai.com/img/str/St_03.gif" alt="">
                <img src="http://www.sanaesai.com/img/res/Ellipse.png" alt="">
            </div>
            <div class="txt_wrap r3">
                <div>땅에 두더지가 있다 생각하고!</div>
                <div>다리를 쫙쫙! 골반은 움직이지 않아요!</div>
                <div>다리만 왔다~ 갔다~</div>
            </div>
        </div>
    </section>
